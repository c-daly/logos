...
import {
  Configuration,
  DefaultApi,
} from '@logos/hermes-client';
import type { EmbedTextOperationRequest } from '@logos/hermes-client';

async function example() {
  console.log("🚀 Testing @logos/hermes-client SDK...");
...
import type { SimpleNlpOperationRequest } from '@logos/hermes-client';
...
import type { SpeechToTextRequest } from '@logos/hermes-client';
...
import type { TextToSpeechOperationRequest } from '@logos/hermes-client';
