    ...
    def make_instance(self, include_optional) -> SimpleNlp200Response:
        ...
        if include_optional:
            return SimpleNlp200Response(
                ...
                pos_tags = [
                    logos_hermes_sdk.models.simple_nlp_200_response_pos_tags_inner.simpleNlp_200_response_pos_tags_inner(
                        token = '', 
                        tag = '', )
                    ],
                lemmas = [
                ...
                entities = [
                    logos_hermes_sdk.models.simple_nlp_200_response_entities_inner.simpleNlp_200_response_entities_inner(
                        text = '', 
                        label = '', 
                        start = 56, 
                        end = 56, )
