...
class EmbedText200Response(BaseModel):
    ...
    """ # noqa: E501
    embedding: list[StrictFloat | StrictInt] | None = Field(default=None, description="Vector embedding")
    dimension: StrictInt | None = Field(default=None, description="Embedding dimension")
    model: StrictStr | None = Field(default=None, description="Model used for embedding")
