...
class TextToSpeechRequest(BaseModel):
    ...
    voice: StrictStr | None = Field(default='default', description="Optional voice identifier")
    language: StrictStr | None = Field(default='en-US', description="Language code (e.g., \"en-US\")")
