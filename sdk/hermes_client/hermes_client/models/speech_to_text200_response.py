...
class SpeechToText200Response(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr | None = Field(default=None, description="Transcribed text")
    confidence: StrictFloat | StrictInt | None = Field(default=None, description="Confidence score (0.0 to 1.0)")
