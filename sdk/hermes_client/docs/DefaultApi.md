...
with hermes_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hermes_client.DefaultApi(api_client)
    simple_nlp_request = hermes_client.SimpleNlpRequest() # SimpleNlpRequest | 
...
with hermes_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hermes_client.DefaultApi(api_client)
    text_to_speech_request = hermes_client.TextToSpeechRequest() # TextToSpeechRequest | 
