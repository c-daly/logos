...
class TestOntologyLoading:
    ...
    def test_constraints_exist(self, neo4j_driver, loaded_ontology):
        ...
        with neo4j_driver.session() as session:
            ...
            assert any("logos_node_uuid" in c for c in constraints), "Node UUID constraint missing"
    ...
    def test_indexes_exist(self, neo4j_driver, loaded_ontology):
        ...
        with neo4j_driver.session() as session:
            ...
            assert any("logos_node_type" in i for i in indexes), "Node type index missing"
            assert any("logos_node_name" in i for i in indexes), "Node name index missing"
            assert any(
