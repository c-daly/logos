...
Tests the simulation service logic with mocked Neo4j driver.
These tests verify service behavior, JEPA integration, and data flow
...
class TestSimulationServiceInitialization:
    """Tests for SimulationService initialization."""
    ...
    def test_initialization_with_custom_jepa_config(self, mock_neo4j_driver):
...
class TestSimulationServiceRunSimulation:
    """Tests for run_simulation method."""

    def test_creates_imagined_process(self, mock_neo4j_driver):
    ...
    def test_stores_in_neo4j(self, mock_neo4j_driver):
        """Test that simulation results trigger Neo4j storage calls."""
        service = SimulationService(mock_neo4j_driver)
        ...
        service.run_simulation(request)
    ...
    def test_with_frame_link(self, mock_neo4j_driver):
        """Test simulation with frame_id triggers frame linking."""
        service = SimulationService(mock_neo4j_driver)
    ...
    def test_preserves_context_assumptions(self, mock_neo4j_driver):
...
class TestSimulationServiceGetResults:
    """Tests for get_simulation_results method."""

    def test_get_simulation_results(self, mock_neo4j_driver):
    ...
    def test_get_simulation_results_not_found(self, mock_neo4j_driver):
