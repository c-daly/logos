"""
Unit tests for /simulate API endpoint.

Tests the FastAPI endpoint logic with mocked Neo4j driver.
These tests verify API contract, validation, and response structure
...
class TestSimulateAPIHealth:
    """Tests for /sophia/health endpoint."""

    def test_health_endpoint(self, test_client):
        """Test the /sophia/health endpoint returns healthy status."""
...
class TestSimulateAPIValidation:
    """Tests for API request validation."""

    def test_simulate_endpoint_invalid_k_steps(self):
        """Test simulation with invalid k_steps returns 422."""
        driver = Mock()
        session = MagicMock()
        driver.session.return_value.__enter__ = Mock(return_value=session)
        driver.session.return_value.__exit__ = Mock(return_value=None)
    ...
    def test_simulate_endpoint_missing_capability_id(self):
        """Test simulation without capability_id returns 422."""
        driver = Mock()
        session = MagicMock()
        driver.session.return_value.__enter__ = Mock(return_value=session)
        driver.session.return_value.__exit__ = Mock(return_value=None)
...
class TestSimulateAPIResponse:
    """Tests for API response structure (with mocked backend)."""

    def test_simulate_endpoint_success(self, test_client):
        """Test successful simulation request returns expected structure."""
        payload = {
            "capability_id": "test-capability",
    ...
    def test_simulate_endpoint_with_frame_id(self, test_client):
    ...
    def test_simulate_endpoint_minimal_steps(self, test_client):
    ...
    def test_simulate_endpoint_complex_context(self, test_client):
    ...
    def test_simulate_default_k_steps(self, test_client):
    ...
    def test_get_simulation_endpoint(self, test_client, mock_neo4j_driver):
